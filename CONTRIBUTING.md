...
1. Add templates in `harness/<platform>/`
2. Add adapter in `harness/<platform>/`
3. Add guide in `concepts/<platform>-guide.md`
...
- Keep AGENTS.md templates within tier limits: starter ~30, standard ~80, advanced ~150 lines
