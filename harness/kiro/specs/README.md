...
.kiro/specs/[feature-name]/
  requirements.md     ← harness/kiro/specs/feature/requirements.md.template
  design.md           ← harness/kiro/specs/feature/design.md.template
  tasks.md            ← harness/kiro/specs/feature/tasks.md.template
```

### Bugfix Spec
```
.kiro/specs/[bug-name]/
  bugfix.md           ← harness/kiro/specs/bugfix/bugfix.md.template
