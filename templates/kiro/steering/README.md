...
when_not_to_use: If you only use Claude Code, see templates/claude-code/ instead.
---
...
cp harness-kit/templates/kiro/steering/product.md.template .kiro/steering/product.md
cp harness-kit/templates/kiro/steering/tech.md.template .kiro/steering/tech.md
cp harness-kit/templates/kiro/steering/structure.md.template .kiro/steering/structure.md

# Add optional domain-specific steering
cp harness-kit/templates/kiro/steering/api-design.md .kiro/steering/
cp harness-kit/templates/kiro/steering/testing-patterns.md .kiro/steering/
cp harness-kit/templates/kiro/steering/debugging-guide.md .kiro/steering/
```
