...
cp harness-kit/templates/claude-code/hooks/pre-tool-use/*.sh .claude/hooks/
cp harness-kit/templates/claude-code/hooks/post-tool-use/*.sh .claude/hooks/
cp harness-kit/templates/claude-code/hooks/stop/*.sh .claude/hooks/
...
PostToolUse: auto-lint.sh + auto-format.sh
Stop:        require-tests.sh + require-lint.sh
```
