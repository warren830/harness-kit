...
**Template**: `templates/claude-code/CLAUDE.md.template`
...
**Templates**: `templates/claude-code/hooks/`
...
**Templates**: `templates/claude-code/rules/`
...
**Templates**: `templates/claude-code/skills/`
