...
This is **error-driven writing** — the core methodology. See [error-driven-methodology.md](error-driven-methodology.md) for the full guide.
...
|-----------|-----------|-------|
| Level 1-2 | Add Hooks (verification gates) | [claude-code-guide.md](claude-code-guide.md) |
| Level 2-3 | Add Skills (progressive context) | [claude-code-guide.md](claude-code-guide.md) |
| Level 3-4 | Add Kiro Specs (structured planning) | [kiro-guide.md](kiro-guide.md) |
| Level 4-5 | Set up entropy management | Templates in `harness/universal/entropy/` |
